...
function makeManifest(overrides: Partial<SyncedAgentsManifest> = {}): SyncedAgentsManifest {
  return {
    ...
    agents: CANONICAL_GEM_TEAM_SLUGS.map((slug) => ({
      ...
      localSlug: slug,
      name: slug,
      sourceUrl: `https://github.com/mubaidr/gem-team/blob/v1.2.3/.apm/agents/${slug}.agent.md`,
      rawUrl: `https://raw.githubusercontent.com/mubaidr/gem-team/v1.2.3/.apm/agents/${slug}.agent.md`,
      upstreamRef: "v1.2.3",
